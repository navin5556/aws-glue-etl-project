...
# transformation_ctx="S3bucket_node1": This is a unique string that is used to track artifacts and errors in AWS Glue. It’s like a label for this particular operation.
